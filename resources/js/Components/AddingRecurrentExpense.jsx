...
export default function AddingRecurrentExpense({ categories }) {
        ...
        <>
            <div className="flex flex-col items-center justify-center gap-1 bg-white p-6 shadow-sm dark:bg-gray-200">
                ...
                <p className="mt-2 text-black">
                    <strong>Did you know?</strong> You can add recurring
                    expenses here — like loans, mortgages, subscriptions, or
                    utility bills — and we’ll automatically log them on the date
                    you choose.
                </p>
                <button
                    onClick={() => setView(!view)}
                    className="max-w-46 mt-2 rounded-md bg-red_primary px-3 py-1 font-semibold text-white hover:bg-quaternary"
                >
